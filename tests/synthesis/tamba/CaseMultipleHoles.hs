...
module CaseMultipleHoles where
...
--  EXPECT
-- { _true_hole : ShipRange | betweenShip secret _true_hole && 
--                            subsetShip _true_hole prior }
--  GOT 
-- {lq_tmp$x##1607: ShipRange | lq_tmp$x##1607 == _true_hole_a1s7}